...
1. [PROJECT_STRUCTURE.md](docs/PROJECT_STRUCTURE.md) - Entenda a nova estrutura
2. [TESTING_GUIDE.md](docs/TESTING_GUIDE.md) - Aprenda os padrões de teste
3. [CONTRIBUTING.md](docs/CONTRIBUTING.md) - Diretrizes de contribuição
